...
public protocol HybridMQTTSpec: AnyObject, HybridObjectSpec {
  ...
  // Methods
  func connect(host: String, port: Double) throws -> String
  func disconnect() throws -> Void
  func subscribe(topic: String, callBack: @escaping ((_ data: String) -> Void)) throws -> Void
  func unsubscribe(topic: String) throws -> Void
  func publish(topic: String, message: String) throws -> String
}
